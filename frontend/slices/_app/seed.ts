...
export const SEED_CLIENTS: Client[] = [
  {
    id: "cl-1",
    name: "Aditya Pratama",
    company: "PT Sinar Mandiri",
    industry: "Manufaktur",
    email: "aditya@sinarmandiri.co.id",
  ...
  },
  {
    ...
    industry: "F&B",
    email: "putri@nusantaragroup.co.id",
  ...
  },
  {
    id: "cl-3",
    name: "Bayu Setiawan",
    company: "Bahtera Logistik",
    industry: "Technology",
    email: "bayu@bahteralogistik.co.id",
...
export const SEED_PROJECTS: Project[] = [
  {
    ...
    contractId: "ct-1",
    clientId: "cl-1",
    name: "Lean Ops Audit — Sinar Mandiri",
  ...
  },
  {
    ...
    contractId: "ct-2",
    clientId: "cl-3",
    name: "Engineering Org — Bahtera Logistik",
